...
Focus* and *Improved Prayer of Healing* are absent. Divine Spirit becoming baseline would be
the natural explanation, but that is not confirmed.
...
### Power in Light — Discipline, row 1, col 1 (5 ranks)
...
### Twin Disciplines — Discipline, row 1, col 3 (5 ranks)
...
### Holy Precision — Discipline, row 2, col 2 (3 ranks)

> Increases your chance to hit with Holy spells by 6%.

`INFERRED` — rank-1 read; higher ranks copied from a matching Classic talent. Reader confidence 1.0.

### Soul Warding — Discipline, row 4, col 3 (1 rank)
...
### Penance — Discipline, row 5, col 2 (1 rank)
...
### Renewed Hope — Discipline, row 5, col 3 (5 ranks)
...
### Divine Aegis — Discipline, row 6, col 3 (3 ranks)
...
### Prayer of Mending — Holy, row 7, col 2 (1 rank)
...
### Early Demise — Shadow Magic, row 6, col 1 (2 ranks)
...
|---|---|---|---|---|
| **Wand Specialization** | Discipline r1c2 | moved from Discipline r1c3; ranks 5 → 2 | — | — |
| **Silent Resolve** | Discipline r2c1 | ranks 5 → 3; rewritten | Reduces the threat generated by your spells by 4%. | Reduces the threat generated by your Holy spells by 10% and reduces the duration of Stun, Fear, and Silence effects inflicted on you by 5%. |
| **Martyrdom** | Discipline r2c4 | rewritten | Gives you a 50% chance to gain the Focused Casting effect that lasts for 6 sec after being the victim of a melee or ranged critical strike. The Focused Casting effect prevents you from losing casting time when taking damage and increases resistance to Interrupt effects by 10%. | Gives you a 50% chance to gain Focused Casting for 6 sec after being the victim of a melee or ranged critical strike. The Focused Casting effect prevents you from losing casting time when taking damage and increases your resistance to Interrupt effects by 20%. |
| **Mental Agility** | Discipline r3c1 | moved from Discipline r4c2; ranks 5 → 3; rewritten | Reduces the mana cost of your instant cast spells by 2%. | Reduces the mana cost of your Smite, Holy Fire, and Instant cast spells by 3%. |
| **Meditation** | Discipline r3c4 | moved from Discipline r3c3 | — | — |
| **Improved Inner Fire** | Discipline r4c1 | rewritten | Increases the Armor bonus of your Inner Fire spell by 10%. | Increases the Armor bonus of your Inner Fire spell by 15% and increases its total charges by 4. |
| **Mental Strength** | Discipline r4c2 | moved from Discipline r5c2; rewritten | Increases your maximum Mana by 2%. | Increases your total Intellect by 3%. |
| **Power Infusion** | Discipline r7c2 | rewritten | Infuses the target with power, increasing their spell damage and healing by 20%. Lasts 15 sec. | Infuses the target with power, increasing their spell damage and healing done by 20% for 15 sec. |
| **Holy Nova** | Holy r3c1 | rewritten | Causes an explosion of holy light around the caster, causing 29 to 34 Holy damage to all enemy targets within 10 yards and healing all party members within 10 yards for 54 to 63. These effects cause no threat. | Causes an explosion of holy light around the caster, causing 30 to 35 Holy damage to all enemy targets within 10 yards and healing all party members within 10 yards for 64 to 73. These effects cause no threat. |
| **Blessed Recovery** | Holy r3c2 | rewritten | After being struck by a melee or ranged critical hit, heal 8% of the damage taken over 6 sec. | After being struck by a melee or ranged critical hit, or suffering more than 30% of your maximum Health from a single attack, heal 8% of the damage taken over 6 sec. Refreshing this effect carries over any remaining healing. |
| **Inspiration** | Holy r3c4 | rewritten | Increases your target's armor by 8% for 15 sec after getting a critical effect from your Flash Heal, Heal, Greater Heal, or Prayer of Healing spell. | Your non-periodic critical heals increase your target's Armor by 8% for 15 sec. |
| **Improved Healing** | Holy r4c2 | rewritten | Reduces the Mana cost of your Lesser Heal, Heal, and Greater Heal spells by 5%. | Reduces the Mana cost of your Lesser Heal, Heal, Greater Heal, Penance, and Prayer of Mending spells by 5%. |
| **Searing Light** | Holy r4c3 | rewritten | Increases the damage of your Smite and Holy Fire spells by 5%. | Increases your Holy damage done by 2%, and gives a 5% chance each time your Holy Fire spell deals periodic damage for your next Holy Nova to cost no Mana. |
| **Spiritual Guidance** | Holy r5c3 | rewritten | Increases spell damage and healing by up to 5% of your total Spirit. | Increases your spell healing by up to 5% of your total Spirit and your spell damage by up to 1% of your total Spirit. |
| **Spiritual Healing** | Holy r6c3 | ranks 5 → 3; rewritten | Increases the amount healed by your healing spells by 2%. | Increases the amount healed by your spells by 3%. |
| **Shadow Focus** | Shadow Magic r1c1 | moved from Shadow r2c3; rewritten | Reduces your target's chance to resist your Shadow spells by 2%. | Increases your chance to hit with your Shadow spells by 1%. |
| **Blackout** | Shadow Magic r1c2 | moved from Shadow r1c3 | — | — |
| **Spirit Tap** | Shadow Magic r1c3 | moved from Shadow r1c2; rewritten | Gives you a 20% chance to gain a 100% bonus to your Spirit after killing a target that yields experience. For the duration, your Mana will regenerate at a 50% rate while casting. Lasts 15 sec. | Gives you a 20% chance to gain a 100% bonus to your Spirit for 15 sec after killing a non-trivial target. For the duration, your Mana will regenerate at a 50% of normal rate while casting. |
| **Shadow Affinity** | Shadow Magic r2c1 | moved from Shadow r2c1 | — | — |
| **Improved Shadow Word: Pain** | Shadow Magic r2c3 | moved from Shadow r2c2 | — | — |
| **Shadow Reach** | Shadow Magic r2c4 | moved from Shadow r4c3; ranks 3 → 2; rewritten | Increases the range of your Shadow damage spells by 6%. | Increases the range of your offensive Shadow spells by 10%. |
| **Improved Mind Blast** | Shadow Magic r3c1 | moved from Shadow r3c2 | — | — |
| **Improved Psychic Scream** | Shadow Magic r3c2 | moved from Shadow r3c1 | — | — |
| **Mind Flay** | Shadow Magic r3c3 | moved from Shadow r3c3 | — | — |
| **Improved Fade** | Shadow Magic r4c1 | moved from Shadow r4c2 | — | — |
| **Vampiric Embrace** | Shadow Magic r4c2 | moved from Shadow r5c2; rewritten | Afflicts your target with Shadow energy that causes all party members to be healed for 20% of any Shadow spell damage you deal for 1 min. | Afflicts your target with Shadow energy that causes all party members to be healed for 20% of any Shadow spell damage you deal for 30 sec. Vampiric Embrace also grants a chance for your Spirit Tap talent to trigger when enemies afflicted by it die. |
| **Shadow Weaving** | Shadow Magic r4c3 | moved from Shadow r4c4; ranks 5 → 3; rewritten | Your Shadow damage spells have a 20% chance to cause your target to be vulnerable to Shadow damage. This vulnerability increases the Shadow damage dealt to your target by 3% and lasts 15 sec. Stacks up to 5 times. | Your Shadow damage spells have a 33% chance to increase the Shadow damage you deal by 2% for 15 sec, stacking up to 5 times. |
| **Silence** | Shadow Magic r5c1 | moved from Shadow r5c1; rewritten | Silences the target, preventing them from casting spells for 5 sec. | Silences the target, preventing them from casting spells for 5 sec and interrupting their spellcasts for 3 sec. |
| **Darkness** | Shadow Magic r6c3 | moved from Shadow r6c3; rewritten | Increases your Shadow spell damage by 2%. | Increases your Shadow damage done by 2%. |
| **Shadowform** | Shadow Magic r7c2 | moved from Shadow r7c2; rewritten | Assume a Shadowform, increasing your Shadow damage by 15% and reducing Physical damage done to you by 15%. However, you may not cast Holy spells while in this form. | Assume Shadowform, increasing your Shadow damage by 10%, reducing the Mana cost of all Shadow spells by 50%, increasing the critical strike damage bonus of your Shadow spells by 100%, and reducing Physical damage taken by you by 15%. However, you may not cast healing spells while in this form. |

<details><summary>Wording-only differences (1) — tooltip rewrites and OCR noise, no mechanical change</summary>

- **Improved Mana Burn** (Discipline) — Classic: *Reduces the casting time of your Mana Burn spell by 0.25 secs.* → Forever: *Reduces the casting time of your Mana Burn spell by 0.5 sec.*
...
Divine Fury, Holy Reach, Holy Specialization, Improved Power Word: Shield, Improved Renew, Inner Focus, Spell Warding, Spirit of Redemption
