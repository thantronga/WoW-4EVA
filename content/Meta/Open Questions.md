...
Tracked for the daily news-diff task. Reviewed and re-scored **13 Sep 2026**, then again after
the Deep Dive panel on **14 Sep 2026**.
...
| Was open | Answer |
|---|---|
| **Skyborne racial abilities — not revealed** | **Closed (Tier 2/3).** *Walk on Air*, *Wind Blessed*, *Elemental Insight* on both variants; *Read Ley Line* (Alliance), *Skysight* (Horde). Read off the demo build's character-creation panels and **already recorded in this vault** — see [[Races, Racials and Combos]]. Residual item: official confirmation of the text, not the names. |
| **Zones for Drowned City, Krol'dok Stronghold, Blackmaw Hold** | **Closed.** Stranglethorn Vale coast / The Riverglades / Azshara. See [[Dungeons]] — two of the three contradicted the standing theories. |
| **Location of Barrow Deeps entrances 2 and 3** | **Partially closed.** Entrance 2 is **Blackmaw Hold's tunnels**. Entrance 3 still unlocated. See [[Raids]]. |
...
- **The legendary reward** from the two new raids — unrevealed. Called only "the first new legendary". **Not mentioned at the Deep Dive panel**, which covered itemization at length. Neither were the **tier sets**.
- **Restoration druid form for Skyborne** — no tree form shown. **Not mentioned at the Deep Dive panel.** Wowhead's dedicated Skyborne-forms article shows **bear, cat and travel only** — which also weakens this vault's "moonkin" observation to single-source. See [[Skyborne]].
- **Identity of the revamped iconic raid** (Summer 2027) — unnamed.
...
- **Beta end date** — official says 21 Oct, two roadmap write-ups read the slide as 22 Oct. **[14 Sep]** A **third** official mention of **21 Oct** has turned up, in the Collector's Edition article (*"September 17 through October 21 PDT"*). Official 3, outlets 2. Still technically open until the slide itself is settled, but the balance has shifted. See [[Roadmap]].
- **Which Australian retailers actually stock the Collector's Edition.** Blizzard says "participating regional retailers" and names none. **[Tier 4 — community report]** Forum posters name **EB Games** (reportedly behind their membership) and **JB Hi-Fi**; **no blue reply, and neither listing could be verified directly.** See [[Editions]].
- ~~**Collector's Edition price and ship date**~~ — **CLOSED 14 Sep (Tier 1).** Blizzard published a dedicated CE article (**24302498**) and the Gear Store listing is live: **\$150.00 USD**, *"not available to ship until November 2026"*. **Both carried-forward [REPORTED] figures were correct.** Also now known: **currently sold out** on the US store, which **ships only to North and South America**; Blizzard directs **Australia and New Zealand to "participating regional retailers"**. See [[Editions]].
...
- **Whether Omen of Clarity and Nature's Grasp are baseline.** Both are **absent from every Druid talent tree** at 469/470 coverage, yet both sit in the Druid Balance spellbook at confidence 1.0, and Omen of Clarity's tooltip is reworked to proc from *"spells and attacks"* rather than melee only. [Tier 4] baseline is the simplest explanation; the extraction project declines to conclude it because demo characters have talent points spent. See [[Baseline Ability Changes]].
- **What *Comprehend Scroll* is for.** A new Mage General ability — 5 yd, Instant, *"Decipher an untranslating scroll"* (probably a misread of *untranslatable*). No context for it exists in any other source.
...
## The Deep Dive panel — aired

> [!success] Aired **Sunday 13 Sep 2026, 10:00 am PDT = 03:00 Mon 14 Sep AEST**. Captured.
> There is an **official Blizzard recap** (news article **24303313**), so most of what it
> revealed is **Tier 1** — a significant change for this vault.
>
> **Revealed:** the full Camping system, the full Legacy system, a **realmless** server model
> with four rulesets, a full transmog ruleset, combat and itemization overhaul (merged hit and
> crit), official racial text for Dwarf and Undead, the **16-point talent milestone**, and a
> **full official Paladin talent list**.
>
> **Corrected:** the "separate Hardcore realms" claim (there are no realms), the "Legacy tree is
> empty" reading (the demo was unfinished), and this vault's scoring of Ion Hazzikostas.
>
> **Did not touch:** the legendary, tier sets, the Skyborne Restoration form, the Summer 2027
> raid, the Barrow Deeps prisoner, entrance 3, dungeon brackets, or the Primary/Secondary tabs.
>
...
## DO NOT FILE — known contamination

> [!danger] Demon Hunter "Devourer" spec
> A Demon Hunter **Devourer** spec appears in some coverage attached to Forever. It belongs to
> **retail patch 12.2 Eclipse** (Midnight), announced at the same BlizzCon.
>
> **Verified 13 Sep 2026:** Devourer is a real retail Demon Hunter DPS spec with existing 12.1
> guides on Icy Veins, Maxroll and Murlok. It has nothing to do with Forever. **Forever has
> nine classes and no Demon Hunters.** The only Demon Hunter in Forever is an unnamed *NPC
> prisoner* in the Barrow Deeps.
>
> If this appears in the vault, remove it.
